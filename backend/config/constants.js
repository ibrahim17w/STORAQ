...
const emailTexts = {
  en: {
    verifySubject: 'Verify your STORAQ account',
    verifySubtitle: 'Welcome aboard!',
    verifyBody: 'Thank you for joining STORAQ! Please enter the verification code below in your app to verify your email address and activate your account.',
    verifyBtn: null,
  ...
  ar: {
    verifySubject: 'تأكيد حسابك على STORAQ',
    verifySubtitle: 'مرحباً بك!',
    verifyBody: 'شكراً لانضمامك إلى STORAQ! أدخل رمز التحقق أدناه في التطبيق لتأكيد بريدك الإلكتروني وتفعيل حسابك.',
    verifyBtn: null,
  ...
  fr: {
    verifySubject: 'Vérifiez votre compte STORAQ',
    verifySubtitle: 'Bienvenue !',
    verifyBody: 'Merci d\'avoir rejoint STORAQ ! Saisissez le code de vérification ci-dessous dans votre application pour vérifier votre adresse e-mail et activer votre compte.',
    verifyBtn: null,
  ...
  es: {
    verifySubject: 'Verifica tu cuenta de STORAQ',
    verifySubtitle: '¡Bienvenido!',
    verifyBody: '¡Gracias por unirte a STORAQ! Introduce el código de verificación a continuación en tu aplicación para verificar tu correo y activar tu cuenta.',
    verifyBtn: null,
  ...
  tr: {
    verifySubject: 'STORAQ hesabınızı doğrulayın',
    verifySubtitle: 'Hoş geldiniz!',
    verifyBody: 'STORAQ\'e katıldığınız için teşekkürler! E-posta adresinizi doğrulamak ve hesabınızı etkinleştirmek için uygulamaya aşağıdaki doğrulama kodunu girin.',
    verifyBtn: null,
  ...
  ur: {
    verifySubject: 'STORAQ اکاؤنٹ کی تصدیق',
    verifySubtitle: 'خوش آمدید!',
    verifyBody: 'STORAQ میں شامل ہونے کا شکریہ! اپنا ای میل تصدیق کرنے اور اکاؤنٹ فعال کرنے کے لیے ایپ میں نیچے دیا گیا تصدیقی کوڈ درج کریں۔',
    verifyBtn: null,
  ...
  hi: {
    verifySubject: 'अपना STORAQ खाता सत्यापित करें',
    verifySubtitle: 'स्वागत है!',
    verifyBody: 'STORAQ में शामिल होने के लिए धन्यवाद! अपना ईमेल सत्यापित करने और खाता सक्रिय करने के लिए ऐप में नीचे दिया गया सत्यापन कोड दर्ज करें।',
    verifyBtn: null,
  ...
  bn: {
    verifySubject: 'আপনার STORAQ অ্যাকাউন্ট যাচাই করুন',
    verifySubtitle: 'স্বাগতম!',
    verifyBody: 'STORAQ-এ যোগ দেওয়ার জন্য ধন্যবাদ! আপনার ইমেইল যাচাই করতে এবং অ্যাকাউন্ট সক্রিয় করতে অ্যাপে নীচের যাচাইকরণ কোডটি লিখুন।',
    verifyBtn: null,
  ...
  ru: {
    verifySubject: 'Подтвердите аккаунт STORAQ',
    verifySubtitle: 'Добро пожаловать!',
    verifyBody: 'Спасибо за регистрацию в STORAQ! Введите код подтверждения ниже в приложении, чтобы подтвердить адрес электронной почты и активировать аккаунт.',
    verifyBtn: null,
  ...
  zh: {
    verifySubject: '验证您的 STORAQ 账户',
    verifySubtitle: '欢迎！',
    verifyBody: '感谢加入 STORAQ！请在应用中输入下方的验证码以验证您的电子邮件地址并激活账户。',
    verifyBtn: null,
